...
const trans = {
    "common": {
        ...
        "knowmore": text("En savoir plus", "Know more"),
    ...
    "homepage": {
        ...
        "studies": text("J’ai appris énormément en autodidacte mais mes études à l’IUT A de Villeneuve-d’Ascq m’ont appris beaucoup sur le travail en équipe et ont énormément renforcé mes compétences en ce qui concerne les bases de données et <a href='https://sql.sh/' target='_blank' class='underline'>SQL</a>.", "I learned a lot on my own, but my studies at IUT A in Villeneuve-d’Ascq taught me a lot about teamwork and greatly strengthened my skills in databases and <a href='https://sql.sh/' target='_blank' class='underline'>SQL</a>."),
        "myproxp": text("Mon expérience professionelle", "My professional experience"),
        "proxp": text("J’ai suivi un stage d’une semaine à <a href='https://www.kimpleapp.com/' target='_blank' class='underline'>Kimple</a> lors de mon année de Seconde durant laquelle j’ai re-créé “Flappy Bird” pour le web. J’ai également suivi un stage de 3 mois chez <a href='https://www.tabuleo.com/' target='_blank' class='underline'>Tabuléo</a> où j’ai contribué au re-design de leur projet “Quizéo”. Je suis désormais en alternance chez eux.", "I did a one-week internship at <a href='https://www.kimpleapp.com/' target='_blank' class='underline'>Kimple</a> during my second year, during which I recreated “Flappy Bird” for the web. I also started an internship in April 2024 at <a href='https://www.tabuleo.com/' target='_blank' class='underline'>Tabuléo</a> where I contributed to the redesign of their “Quizéo” project. As of right now I'm still working there as an intern."),
        "myfreelance": text("Ma freelance", "My freelance"),
        "freelance": text("Grâce au bouche-à-oreille, des entrepreneurs m’ont contacté pour que je leur crée un site web d’entreprise. Cela m’a appris beaucoup car j’ai dû réaliser des projets clients de A à Z, seul et en respectant des délais précis.", "Through word of mouth, entrepreneurs have contacted me to create a business website for them. This has taught me a lot because I have had to complete client projects from A to Z, alone and within precise deadlines."),
