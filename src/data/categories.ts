import type { Localized, ProjectCategory, ProjectContext, TechRoleId } from "./models";
...
export const CATEGORIES: Record<ProjectCategory, CategoryMeta> = {
    ...
    software: { label: { fr: "Logiciels", en: "Software" }, single: { fr: "Logiciel", en: "Software" }, title: { fr: "Mes logiciels", en: "My software" }, dot: "#45D483" },
